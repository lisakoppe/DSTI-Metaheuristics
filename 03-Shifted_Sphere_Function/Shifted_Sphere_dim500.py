# Continuous Optimization: Shifted Sphere Function (F1) with D=500
...
def plot_fitness(solution):
    ...
    plt.plot(solution)
    plt.title("Continuous Optimization: Shifted Sphere Function (F1) with D=500", fontsize=16)
    plt.xlabel("Time (iterations)", fontsize=12)
    plt.ylabel("Fitness", fontsize=12)
    plt.savefig("Screenshots/Sphere_convergence_curve500.png")
    plt.show()
...
sol_df.to_csv("Sphere_sol500.csv", sep=",")
print("\n    - Solutions:", sol_df)
