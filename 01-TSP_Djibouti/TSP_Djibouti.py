# Report:
#   The chosen algorithm and a justification of this choice: Simulated Annealing Algorithm
...
# Travelling Salesman Problem with mlrose package (Genetic Algorithm)
# Djibouti 38 cities
